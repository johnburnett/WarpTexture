		...
		case WM_COMMAND:
		{
			switch (LOWORD(wParam))
			{
				case IDC_ABOUT_WEB:
				{
					...
					if ( ShellExecute(hWnd, NULL, "http://www.footools.com/aboutplugin/warptexture.html", NULL, NULL, NULL) < (HINSTANCE) 32 )
	#else
					if ( ShellExecute(hWnd, NULL, _T("http://www.footools.com/aboutplugin/warptexture.html"), NULL, NULL, NULL) < (HINSTANCE) 32 )
	#endif
#endif
					{
